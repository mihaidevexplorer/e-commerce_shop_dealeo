...
const Shops = () => {
    ...
    return (
           ...
           <section className='py-16'>
            ...
            <div className='w-full flex flex-wrap'>
                <div className={`w-3/12 md-lg:w-4/12 md:w-full pr-8 ${filter ? 'md:h-0 md:overflow-hidden md:mb-6' : 'md:h-auto md:overflow-auto md:mb-0' } `}>
                    <h2 className='text-3xl font-bold mb-3 text-gray-900'>Category </h2>
        <div className='py-2'>
            {
                categorys.map((c,i) => <div key={i} className='flex justify-start items-center gap-2 py-1'>
                    ...
                    <label className='text-gray-900 block cursor-pointer' htmlFor={c.name}>{c.name}</label>
                </div>)
            }
        </div>
         ...
         <div className='py-3 flex flex-col gap-4'>
            ...
            <div className='flex flex-col gap-3'>
                 <div onClick={() => setRating(5)} className='text-orange-500 flex justify-start items-start gap-2 text-xl cursor-pointer'>
                    <span><AiFillStar className=" w-6 h-6"/> </span>
        ...
        <div className='w-9/12 md-lg:w-8/12 md:w-full'>
            <div className='pl-8 md:pl-0'>
                <div className='py-4 bg-white mb-10 px-3 rounded-md flex justify-between items-start border'>
                    <h2 className='text-lg font-medium text-blue-900'> ({totalProduct}) Products </h2>
        ...
        <div className='flex justify-center items-start gap-4 md-lg:hidden'>
            ...
            <div onClick={()=> setStyles('list')} className={`p-2 ${styles === 'list' && 'bg-gray-300'} text-gray-600 hover:bg-gray-300 cursor-pointer rounded-sm `} >
                  <FaThList/>  
            </div> 
        </div> 
        </div> 
