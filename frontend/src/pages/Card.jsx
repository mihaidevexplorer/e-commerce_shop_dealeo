...
<div className='w-[33%] md-lg:w-full'>
    <div className='pl-3 md-lg:pl-0 md-lg:mt-5'>
        {
            card_products.length > 0 && <div className='bg-white p-3 text-gray-700 flex flex-col gap-3'>
                ...
                <input className='w-full px-3 py-2 border border-gray-200 outline-0 focus:border-orange-500 rounded-sm' type="text" placeholder='Input Vauchar Coupon' />
                <button className='px-5 py-[1px] bg-[#ff7f50] text-white rounded-sm uppercase text-sm'>Apply</button>
                </div>

                <div className='flex justify-between items-center'>
                    <span>Total</span>
                    <span className='text-lg text-[#ff7f50]'>${price + shipping_fee} </span>
                </div>
            ...
            : <div>
                <Link className='px-4 py-1 bg-orange-500 text-white' to='/shops' > Shop Now</Link>
            </div>
        }
