...
import EmojiPicker from 'emoji-picker-react'; // Importăm EmojiPicker
...
const Chat = () => {
    ...
    const [showEmojiPicker, setShowEmojiPicker] = useState(false); // Control pentru afișarea picker-ului
