...
class authControllers{
    ...
    profile_image_upload = async(req, res) => {
        ...
        form.parse(req, async(err,_,files) => {
            ...
            const imagePath = Array.isArray(image) ? image[0].filepath : image.filepath;// Aici parca pare tot in regula

            if (!imagePath) {
                //console.error("Image file path is undefined");
                return responseReturn(res, 400, { error: "Invalid image file path" });
            }
            ...
            try {
                ...
                //console.log("Cloudinary upload profile:", result);
